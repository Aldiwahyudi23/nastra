            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="header-top-left">
                        <div class="logo-area">
                            @if (@$footer->logo == NULL)
                            <img class="img-responsive" src="{{asset('Assets/Frontend/img/nastra-logo.png')}}" alt="logo">
                        @else
                    ...
                    <nav id="desktop-nav">
                        <ul>
                            ...
                            <li><a href="#">Tentang Kami</a>
                                <ul>
                                    <li><a href=" {{route('profile.nastra')}} ">Profile Nastra</a></li>
                                    <li><a href=" {{route('visimisi.nastra')}} ">Visi dan Misi</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="{{ (request()->is('artikel')) ? 'active' : '' }}"><a href=" {{route('artikel')}} ">Artikel</a></li>
                ...
                <div class="mobile-menu">
                    <nav id="dropdown">
                        <ul>
                            ...
                            <li><a href="#">Tentang Kami</a>
                                <ul>
                                    <li><a href=" {{route('profile.nastra')}} ">Profile</a></li>
                                    <li><a href=" {{route('visimisi.nastra')}} ">Visi dan Misi</a></li>
                                </ul>
                            </li>
